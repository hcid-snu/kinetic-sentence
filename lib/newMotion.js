...
(function() {
    ...
    = function(duration, delayWord) {
        ...
        .each(function(l, li) {
            var self = this;
            wigglyScaleChain(self, d, 6 + Math.random() * 2);
        });
    ...
    = function(scale, x1, duration, delayWord) {
        var self = this;
        var i = self.attr("class").split(" ")[1]
        var d = self.datum();
        var posX = 0;
        ...
        (function repeat() {
            if (repCount-- >= 1) {
                ...
                .attr("transform", function(l, li) {
                    ...
                    return "translate(" + [(d.x - d.totalW * 0.5 + l.posX* scale  + x), d.y + y ] + ")scale(" + [scale, scale] + ")"
                })
                .transition()
                .attr("transform", function(l, li) {
                    var x = y = 0;
    ...
    function happyChain(self, d, repCount) {
        repCount = repCount | 6;
        var letter = d3.select(self); // select a letter;
        (function repeat() {
            if (repCount-- >= 1) {
