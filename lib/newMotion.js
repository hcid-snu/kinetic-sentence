...
(function() {
    ...
    = function(duration, delayWord) {
        ...
        .each("end", function(l,li) {
            ...
            .delay(function() {
                return  Math.random() * 200 * li;
            })
            .each(function() {
                 wigglyScaleChain(this, d, 2);
             });
        })
    ...
    = function(deg, y1, duration, delayWord, delayLetter) {
        ...
        .each("end", function(l,li) {
            ...
            .each(function() {
                happyChain(this, d, 1, duration, delayLetter*d.letters.length + delayLetter*(d.letters.length-li -1));            
            });
        })
        return self;
    }
    ...
    = function(y1, duration, delayWord, delayLetter) {
        ...
        .each("end", function(l,li) {
            ...
            .duration(duration)
            .delay(function() {
                return  200 + delayLetter * Math.random() ;
            })
            .each(function() {
                rainingChain(this, d, 10);
            })
            .transition()
            .text(function(l) {
                return l.letter
