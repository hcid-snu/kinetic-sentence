var Inputs= function() {
  ...
  this.types = {Negative:['fadeIn', 'scaleDown', 'raining', 'jitter'], Positive:['fadeIn', 'scaleUp', 'wigglyScale', 'bounce']}
  this.neuTypes = ['fadeIn']//['dropIn', 'fadeIn', 'fadeOut', 'spinIn']
  this.negTypes = ['fadeIn', 'scaleDown', 'raining', 'jitter']
  ...
  this.setMotion = (function() {
    return function (self,d, delays) {
      if (d.type === 'dropIn') {
        ...
        var duration = getDuration(800, 40, d.energy)
        var delayLetter = 0; 
        ...
        var duration = getDuration(80, 8, d.energy);
        var delayLetter = getDuration(200, 40, d.energy);
        d3.select(self).raining(d.size*0.25, duration, delays, delayLetter); 
        ...
        d3.select(self).jitter(getDuration(1.2, -.04, d.energy), getDuration(60, -8, d.energy), 4, duration, delays);
